...
/**
 * Services page social card.
 *
 * Composed with studio mark, wordmark, and services focus.
 */
export const runtime = "nodejs";
export const alt = "ARCHITAK Services — Six disciplines, one studio";
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Services · Six disciplines, one studio
          </div>
        </div>
